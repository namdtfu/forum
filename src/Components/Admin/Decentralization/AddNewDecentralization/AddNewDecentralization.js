...
import "./AddNewDecentralization.css";

class AddNewDecentralization extends Component {
    render() {
        return (
            <div className="container addNewDecentralization">
...
export default AddNewDecentralization;